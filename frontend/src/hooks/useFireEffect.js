...
export const useFireEffect = (canvasId, targetElementId, config = {}) => {
  ...
  useEffect(() => {
    ...
    // Create texture from DOM element using html2canvas
    async function createTextureFromElement() {
      ...
      gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, elementCanvas);
  ...
  }, [canvasId, targetElementId, config]);
};
